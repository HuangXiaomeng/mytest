...
public class MytestService {
  ...
  public interface Iface {
    ...
    public THelloWorldResponse sayHello(THelloWorldRequest request) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void sayHello(THelloWorldRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void send_sayHello(THelloWorldRequest request) throws org.apache.thrift.TException
    {
    ...
    public THelloWorldResponse recv_sayHello() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class sayHello_call extends org.apache.thrift.async.TAsyncMethodCall {
      private THelloWorldRequest request;
      public sayHello_call(THelloWorldRequest request, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public THelloWorldResponse getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class sayHello<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, sayHello_args, THelloWorldResponse> {
      public sayHello() {
        super("sayHello");
      }
      ...
      public AsyncMethodCallback<THelloWorldResponse> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<THelloWorldResponse>() { 
          public void onComplete(THelloWorldResponse o) {
            sayHello_result result = new sayHello_result();
            result.success = o;
            try {
      ...
      public void start(I iface, sayHello_args args, org.apache.thrift.async.AsyncMethodCallback<THelloWorldResponse> resultHandler) throws TException {
  ...
  public static class sayHello_args implements org.apache.thrift.TBase<sayHello_args, sayHello_args._Fields>, java.io.Serializable, Cloneable, Comparable<sayHello_args>   {
    ...
    private THelloWorldRequest request; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.REQUEST, new org.apache.thrift.meta_data.FieldMetaData("request", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, THelloWorldRequest.class)));
    ...
    public sayHello_args(sayHello_args other) {
      if (other.isSetRequest()) {
        this.request = new THelloWorldRequest(other.request);
      }
    }
    ...
    public THelloWorldRequest getRequest() {
      return this.request;
    }

    public void setRequest(THelloWorldRequest request) {
      this.request = request;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case REQUEST:
        if (value == null) {
          ...
          setRequest((THelloWorldRequest)value);
        }
        break;
          ...
          switch (schemeField.id) {
            case 1: // REQUEST
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.request = new THelloWorldRequest();
  ...
  public static class sayHello_result implements org.apache.thrift.TBase<sayHello_result, sayHello_result._Fields>, java.io.Serializable, Cloneable, Comparable<sayHello_result>   {
    ...
    private THelloWorldResponse success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, THelloWorldResponse.class)));
      metaDataMap = Collections.unmodifiableMap(tmpMap);
    ...
    public sayHello_result(sayHello_result other) {
      if (other.isSetSuccess()) {
        this.success = new THelloWorldResponse(other.success);
      }
    }
    ...
    public THelloWorldResponse getSuccess() {
      return this.success;
    }

    public void setSuccess(THelloWorldResponse success) {
      this.success = success;
    }
    ...
    public void setFieldValue(_Fields field, Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((THelloWorldResponse)value);
        }
        break;
      ...
      public void read(org.apache.thrift.protocol.TProtocol iprot, sayHello_result struct) throws org.apache.thrift.TException {
        ...
        while (true)
        {
          ...
          switch (schemeField.id) {
            case 0: // SUCCESS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.success = new THelloWorldResponse();
